...
public class CustomerTest {
	...
	public void testTotalCharge() {
		...
		String statement = customer.statement();
		String expectedChargeContent = "Amount owed is 18.0";

		assertTrue(statement.contains(expectedChargeContent));
	}
	...
	public void testTotalFrequentRenterPoints() {
		...
		String statement = customer.statement();
		String expectedFrequentPointsContent = "You earned 3 frequent renter points";

		assertTrue(statement.contains(expectedFrequentPointsContent));
	}
	...
	public void testAllStatement() {
		...
		assertTrue(statement.contains(newReleaseMovieName + "\t" + 3.0));
		assertTrue(statement.contains(childrensMovieName + "\t" + 15.0));
	}
